classdef object_plan_incl < hgsetget & obstacle
    ...
    methods
        function obj = object_plan_incl (y_0,angle,center_x,center_y,center_z,side_x,side_y,side_z)
          obj.y_0=y_0;
          obj.angle=angle;
          obj.side_x=side_x;
          obj.side_y=side_y;
