...
function [dist_1,dist_2,dist_3,dist_4,dist_5,dist_6,dist_7,dist_8] = distance_UWB_8(anclas,pos_drone_x,pos_drone_y,pos_drone_z)
...
vector_d7=posicion_drone-anclas.a7;
dist_7=norm(vector_d7);
dist_7=dist_7+(error_lim_inf+(error_lim_sup-error_lim_inf)*rand);

if (dist_7 < dist_min_detected)
    dist_7=dist_min_detected;
end
if (dist_7 > dist_max_detected)
    dist_7=dist_max_detected;
end

vector_d8=posicion_drone-anclas.a8;
dist_8=norm(vector_d8);
dist_8=dist_8+(error_lim_inf+(error_lim_sup-error_lim_inf)*rand);

if (dist_8 < dist_min_detected)
    dist_8=dist_min_detected;
end
if (dist_8 > dist_max_detected)
    dist_8=dist_max_detected;
end
